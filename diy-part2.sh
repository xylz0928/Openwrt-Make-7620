...
# 修改版本号-webui
modelmark=R`TZ=UTC-8 date +%Y-%m-%d -d +"2"hours`' by xylz0928'
...
# 修改版本号-tty
sed -i "s/timestamp/Built on '$(TZ=UTC-8 date +%Y-%m-%d -d +"2"hours)' by xylz0928/g" ./package/base-files/files/etc/banner
